...
(function () {
  ...
  var DICT = {
    ...
    'zh-TW': {
      ...
      'sec.new.title': 'v0.2.12 已經發布',
      'sec.new.desc': '本次聚焦庫存工作台與銷售履約的穩定性修復，並補齊三語在地化與窄屏互動。完整版本記錄見更新日誌。',
      'nw.ocr.title': '📦 庫存與工作台',
      'nw.ocr.1': '修復鍵盤遮擋富內容彈窗，補齊庫存流水三語與備註來源',
      'nw.ocr.2': '收斂預設篩選並合併售罄歸檔，重構窄屏投入佈局',
      'nw.ocr.3': '完成現貨銷售發貨拆分與庫存分類',
      'nw.gate.title': '🔔 訂單與在地化',
      'nw.gate.1': '修復排產覆蓋與動態權限申請、預售履約與退款預填',
      'nw.gate.2': '對齊社群支付依賴邊界，升級至 0.2.12（建置號 218）',
      'nw.all': '查看完整更新日誌',

      /* 下載 */
      'sec.dl.eyebrow': '下載與聯繫',
      'sec.dl.title': '把烘豆師帶進你的工坊',
      'dl.meta': '目前版本 v<span data-version="0.2.12">0.2.12</span> · Android / iOS 雙平台',
    ...
    'en': {
      ...
      'sec.new.title': 'v0.2.12 Is Out',
      'sec.new.desc': 'This release focuses on stability fixes for the inventory workspace and sales fulfillment, plus completed trilingual localization and narrow-screen interaction. See the changelog for details.',
      'nw.ocr.title': '📦 Inventory & Workspace',
      'nw.ocr.1': 'Fixed keyboard occluding rich dialogs; completed trilingual inventory ledger and note sources',
      'nw.ocr.2': 'Tightened default filters and merged sold-out archiving; rebuilt narrow-screen input layout',
      'nw.ocr.3': 'Completed spot-sale shipment split and inventory classification',
      'nw.gate.title': '🔔 Orders & Localization',
      'nw.gate.1': 'Fixed scheduling overwrite and dynamic permission requests; pre-order fulfillment and refund prefill',
      'nw.gate.2': 'Aligned community payment dependency boundaries; bumped to 0.2.12 (build 218)',
      'nw.all': 'View Full Changelog',

      /* Download */
      'sec.dl.eyebrow': 'Download & Contact',
      'sec.dl.title': 'Bring Bean Roaster to Your Roastery',
      'dl.meta': 'Current version v<span data-version="0.2.12">0.2.12</span> · Android / iOS',
