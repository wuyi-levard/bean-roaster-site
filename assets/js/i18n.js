...
(function () {
  ...
  var DICT = {
    ...
    'zh-TW': {
      ...
      'sec.new.title': 'v0.2.13 已經發布',
      'sec.new.desc': '本次重點是修復升級誤拒（0.2.10–0.2.12 使用者建議升級），並加固匯出穩定性。完整版本記錄見更新日誌。',
      'nw.ocr.title': '🛡️ 升級與資料',
      'nw.ocr.1': '修復升級誤拒：遷移收斂為唯一序列，並建立升級防復發三道防線',
      'nw.ocr.2': '舊烘焙豆模型定為永久歸檔層，凍結舊寫入路徑避免新舊互相污染',
      'nw.ocr.3': '匯出儲存失敗不再靜默，避免「提示成功 + 0 位元組檔案」',
      'nw.gate.title': '📄 匯出與體驗',
      'nw.gate.1': '豆單 PDF 排版壓縮移出主 isolate，消除匯出時的後台 ANR 斷流',
      'nw.gate.2': '升級至 0.2.13（建置號 219）',
      'nw.all': '查看完整更新日誌',

      /* 下載 */
      'sec.dl.eyebrow': '下載與聯繫',
      'sec.dl.title': '把烘豆師帶進你的工坊',
      'dl.meta': '目前版本 v<span data-version="0.2.13">0.2.13</span> · Android / iOS 雙平台',
      'dl.btn.github': '↓ GitHub Releases 下載',
      'dl.btn.baidu': '↓ 百度網盤下載',
      'dl.repo': '查看原始碼倉庫',
      'dl.wx': '微信：',
      'dl.email': '信箱：',
      ...
      'cl.eyebrow': '更新日誌',
      'cl.h2': '烘豆師版本更新記錄',
      'cl.lead': '以下為公開發布版本的能力演進。最新版本 APK 見 <a href="https://github.com/wuyi-levard/bean-roaster-site/releases" target="_blank" rel="noopener">GitHub Releases</a> 或 <a href="https://pan.baidu.com/s/17-IyWG9qE9T9fcUgi1DNUA?pwd=bnyg" target="_blank" rel="noopener">百度網盤</a>。',
      'cl.tag.new': '最新',
      ...
      'cl.v013.date': '2026-09-13',
      'cl.v013.up.title': '🛡️ 升級與資料',
      'cl.v013.up.1': '修復升級誤拒（重要）：遷移收斂為唯一序列並建立三道防線（全版本升級矩陣、發行版真實庫 fixtures、SQLite 契約）；先前 0.2.10–0.2.12 使用者升級後可能被要求重新匯入備份',
      'cl.v013.up.2': '舊烘焙豆模型定為永久歸檔層並凍結舊寫入路徑；匯出儲存失敗不再靜默（避免「提示成功 + 0 位元組檔案」）',
      'cl.v013.exp.title': '📄 匯出穩定性',
      'cl.v013.exp.1': '豆單 PDF 排版壓縮移出主 isolate，消除匯出時的後台 ANR 斷流',
      'cl.v013.exp.2': '限定批量目錄寫入至行動端，收斂分頁',
      'cl.v013.ux.title': '🎛️ 體驗修復',
      'cl.v013.ux.1': '首層兩次返回退出；設定頁客戶名稱併入品牌卡片',
      'cl.v013.ux.2': '主題分段按鈕三段均分；匯出精靈沖煮參數區間距與提示完整顯示',
      'cl.v012.date': '2026-09-06',
      'cl.v012.inv.title': '📦 庫存與工作台',
      'cl.v012.inv.1': '修復鍵盤遮擋富內容彈窗，補齊庫存流水三語與備註來源，重構窄屏投入佈局',
      'cl.v012.inv.2': '收斂預設篩選並合併售罄歸檔，修復生豆處理法快捷項依目前語言回填',
      'cl.v012.sales.title': '🚚 銷售履約',
      'cl.v012.sales.1': '完成現貨銷售發貨拆分與庫存分類',
      'cl.v012.order.title': '🔔 訂單與提醒',
      'cl.v012.order.1': '修復排產覆蓋與動態權限申請、預售履約顯示、排產執行與退款預填',
      'cl.v012.order.2': '修正 CVA 波段並啟用背景精確通知',
      'cl.v012.i18n.title': '🌐 隱私與在地化',
      'cl.v012.i18n.1': '在地化權限用途說明，補齊三語展示與窄屏互動，優化首頁英文統計卡佈局',
      'cl.v011.date': '2026-09-05',
      'cl.v011.cva.title': '☕ 杯測（CVA）',
      'cl.v011.cva.1': '落地真實 CVA 評分模型與總分規則，接入選項式杯測與統計持久化',
      'cl.v011.cva.2': '重構杯測表為真實 CVA 評估，完成滑桿杯測與描述筆記重構',
      'cl.v011.privacy.title': '🛡️ 隱私與權限',
      'cl.v011.privacy.1': '建立版本化政策事實源與同意狀態，新增啟動同意門禁與隱私/權限設定頁',
      'cl.v011.privacy.2': '通知權限改為按需申請，加固跨解除安裝備份與還原',
      'cl.v011.order.title': '🧾 訂單與客戶',
      'cl.v011.order.1': '補齊分次退貨退款閉環，改善訂單排序與響應式可用性',
      'cl.v011.order.2': '修復預售排產投入映射與售後庫存閉合',
      'cl.v011.i18n.title': '🌐 全面在地化',
      'cl.v011.i18n.1': '補齊三語展示與歷史資料兜底，修復窄屏互動與英文佈局',
      ...
      'pv.s3t': '網路與權限',
      'pv.s3b': '相機僅在你點擊掃碼或拍照辨識時申請，用於掃描 SKU 二維碼或拍攝生豆袋標籤，OCR 在裝置端完成；拒絕後可手動輸入、搜尋或從系統圖片選擇器匯入。排程提醒使用本機通知，不讀取或寫入系統日曆。只有你主動開啟庫存預警或排程提醒時，才申請通知權限和 Android 精確鬧鐘權限；提醒可包含提示音和震動。拒絕通知權限後仍顯示 App 內橫幅；精確鬧鐘被系統關閉時可在系統設定中重新開啟。Android 版另會宣告「開機自啟」權限，僅用於裝置重新啟動後還原你已設定的排程提醒；該權限不讀取任何資料。系統檔案選擇器只讀取你明確選擇的圖片、檔案或共享目錄。',
      'pv.s4t': '離線 OCR 與圖片',
      ...
      'pv.s6t': '專業版授權',
      'pv.s6b': 'sqflite/SQLite、provider、fl_chart、file_picker、pdf、image、PaddleOCR/ONNX/OpenCV 僅用於本機資料庫、介面、圖表、檔案、文件、圖片和裝置端 OCR，不上傳 App 業務資料。in_app_purchase（Apple StoreKit / Google Play Billing）僅用於商店購買、還原交易和判定專業版權益；平台會按自身規則處理交易所需資訊，開發者不接收庫存、訂單或客戶業務資料。flutter_local_notifications 僅建立本機庫存預警和排程提醒；通知可包含提示音和震動，不讀取或寫入系統日曆。dynamic_color（Android 12+ 系統動態取色）僅讀取系統主題色調用於介面配色，可隨時在設定中關閉，不讀取業務資料。產品不接入統計、廣告、崩潰上報、社交登入或雲端同步 SDK。',
      ...
      'pv.s9t': '你的權利與控制',
      'pv.s9b': 'App 不提供帳號註冊、登入或帳號註銷。你可以在 App 內清空本機業務資料，或解除安裝 App 刪除 App 私有資料；共享目錄中的備份由你自行刪除。你也可以在「設定 → 隱私與權限」撤回本政策的同意；撤回會清除本機業務資料、關閉本機提醒，並返回首次使用時的同意頁面。你可以透過 operations@levard.cn 諮詢、請求更正或刪除社群授權台帳；在資料齊全且無需額外核驗的情況下，我們的服務目標是不超過 15 個工作日完成或給出處理結果。',
      'pv.s10t': '兒童隱私',
    ...
    'en': {
      ...
      'sec.new.title': 'v0.2.13 Is Out',
      'sec.new.desc': 'This release focuses on fixing upgrade rejections (users on 0.2.10–0.2.12 should upgrade) and hardening export stability. See the changelog for details.',
      'nw.ocr.title': '🛡️ Upgrade & Data',
      'nw.ocr.1': 'Fixed upgrade rejections: migrations consolidated into a single sequence with three regression defenses',
      'nw.ocr.2': 'Legacy roasted-bean model locked as a permanent archive layer; legacy write path frozen',
      'nw.ocr.3': 'Export save failures are no longer silent — no more "success" with a 0-byte file',
      'nw.gate.title': '📄 Export & Polish',
      'nw.gate.1': 'Moved menu PDF layout compression off the main isolate, eliminating background ANR stalls',
      'nw.gate.2': 'Bumped to 0.2.13 (build 219)',
      'nw.all': 'View Full Changelog',

      /* Download */
      'sec.dl.eyebrow': 'Download & Contact',
      'sec.dl.title': 'Bring Bean Roaster to Your Roastery',
      'dl.meta': 'Current version v<span data-version="0.2.13">0.2.13</span> · Android / iOS',
      'dl.btn.github': '↓ Download via GitHub Releases',
      'dl.btn.baidu': '↓ Download via Baidu Netdisk',
      ...
      'cl.lead': 'Capability evolution across public releases. Get the latest APK from <a href="https://github.com/wuyi-levard/bean-roaster-site/releases" target="_blank" rel="noopener">GitHub Releases</a> or <a href="https://pan.baidu.com/s/17-IyWG9qE9T9fcUgi1DNUA?pwd=bnyg" target="_blank" rel="noopener">Baidu Netdisk</a>.',
      'cl.tag.new': 'Latest',
      'cl.tag.published': 'Public Release',
      'cl.ocr.title': '📦 Inventory & Workspace',
      ...
      'cl.gate.title': '🔔 Orders & Localization',
      'cl.gate.1': 'Fixed scheduling overwrite and dynamic permission requests; pre-order fulfillment and refund prefill',
      ...
      'cl.v013.date': '2026-09-13',
      'cl.v013.up.title': '🛡️ Upgrade & Data',
      'cl.v013.up.1': 'Fixed upgrade rejections (important): migrations consolidated into a single sequence with three regression defenses (full upgrade matrix, released-build fixtures, SQLite contract); users on 0.2.10–0.2.12 could previously be asked to re-import a backup after upgrading',
      'cl.v013.up.2': 'Legacy roasted-bean model locked as a permanent archive layer; legacy write path frozen; export save failures are no longer silent',
      'cl.v013.exp.title': '📄 Export Stability',
      'cl.v013.exp.1': 'Moved menu PDF layout compression off the main isolate, eliminating background ANR stalls',
      'cl.v013.exp.2': 'Restricted batch directory writes to mobile and tightened pagination',
      'cl.v013.ux.title': '🎛️ Experience Fixes',
      'cl.v013.ux.1': 'Double back to exit at the root route; customer name merged into the brand card in Settings',
      'cl.v013.ux.2': 'Theme segmented buttons split evenly; export wizard brew-parameter spacing and hint copy fixed',
      'cl.v012.date': '2026-09-06',
      'cl.v012.inv.title': '📦 Inventory & Workspace',
      'cl.v012.inv.1': 'Fixed keyboard occluding rich dialogs, completed trilingual inventory ledger and note sources, rebuilt narrow-screen input layout',
      'cl.v012.inv.2': 'Tightened default filters and merged sold-out archiving; fixed green-bean process shortcut refill by current language',
      'cl.v012.sales.title': '🚚 Sales Fulfillment',
      'cl.v012.sales.1': 'Completed spot-sale shipment split and inventory classification',
      'cl.v012.order.title': '🔔 Orders & Reminders',
      'cl.v012.order.1': 'Fixed scheduling overwrite and dynamic permission requests; pre-order fulfillment display, scheduling execution and refund prefill',
      'cl.v012.order.2': 'Corrected CVA bands and enabled background exact alarms',
      'cl.v012.i18n.title': '🌐 Privacy & Localization',
      'cl.v012.i18n.1': 'Localized permission-purpose copy, completed trilingual display and narrow-screen interaction, improved English stats-card layout',
      'cl.v011.date': '2026-09-05',
      'cl.v011.cva.title': '☕ Cupping (CVA)',
      'cl.v011.cva.1': 'Shipped a real CVA scoring model with total-score rules and option-based cupping with persisted stats',
      'cl.v011.cva.2': 'Rebuilt the cupping sheet as a real CVA assessment; completed slider cupping and description notes',
      'cl.v011.privacy.title': '🛡️ Privacy & Permissions',
      'cl.v011.privacy.1': 'Added a versioned policy fact-source and consent state, plus a launch consent gate and privacy/permissions settings page',
      'cl.v011.privacy.2': 'Notification permission now requested on demand; hardened cross-uninstall backup and restore',
      'cl.v011.order.title': '🧾 Orders & Customers',
      'cl.v011.order.1': 'Closed the split return/refund loop; improved order sorting and responsive usability',
      'cl.v011.order.2': 'Fixed pre-order scheduling input mapping and after-sales inventory closure',
      'cl.v011.i18n.title': '🌐 Full Localization',
      'cl.v011.i18n.1': 'Completed trilingual display with legacy-data fallbacks; fixed narrow-screen interaction and English layout',
      ...
      'pv.s3b': 'Camera access is requested only when you tap scan or photograph-recognition, to scan SKU QR codes or photograph green-bean labels; OCR runs on-device. If you refuse, you can type, search, or choose an image manually. Production reminders use local notifications and do not read or write the system calendar. Notification and Android exact-alarm permissions are requested only when you actively enable stock or production reminders; notifications may include sound and vibration. If notification permission is denied, in-app banners remain available; if exact alarms are disabled, you can re-enable them in system settings. The Android build also declares a boot-completed permission solely to restore your scheduled production reminders after the device restarts; it does not read any data. The system file picker reads only files or directories that you explicitly choose.',
      ...
      'pv.s6b': 'sqflite/SQLite, provider, fl_chart, file_picker, pdf, image, PaddleOCR/ONNX/OpenCV are used for local storage, UI, charts, file/document/image handling, and on-device OCR; they do not upload app business data. in_app_purchase (Apple StoreKit / Google Play Billing) is used for store purchases, transaction restoration, and Pro entitlement checks; the platform handles information required for the transaction under its own rules, while the developer does not receive inventory, order, or customer business data. flutter_local_notifications creates local stock-alert and production-reminder notifications only; notifications may include sound and vibration, and the app does not read or write the system calendar. dynamic_color (Android 12+ system dynamic theming) only reads the system theme colors for the interface palette and can be turned off at any time in settings; it does not read business data. The product does not integrate analytics, advertising, crash reporting, social login, or cloud-sync SDKs.',
      ...
      'pv.s9b': 'The app does not provide account registration, login, or account cancellation. You can clear local business data in the app or uninstall it to delete app-private data; you delete shared-directory backups yourself. You can also withdraw your consent to this policy in Settings -> Privacy & permissions; withdrawing clears local business data, turns off local reminders, and returns to the first-run consent screen. You may email operations@levard.cn to ask questions or request correction or deletion of the community authorization ledger. When the information is complete and no additional verification is required, our service target is to complete the request or provide a result within 15 business days.',
      'pv.s10t': 'Children',
